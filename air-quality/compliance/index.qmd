...
# Nitrogen Dioxide annual mean Zone Agglomeration 2021
# Source: DEFRA
# URL: https://compliance-data.defra.gov.uk/datasets/Defra::nitrogen-dioxide-annual-mean-zone-agglomeration-2021/explore
no2_annual <- read_csv("data/Nitrogen_Dioxide_annual_mean_Zone_Agglomeration_2021.csv")

# Nitrogen Dioxide hourly mean Zone Agglomeration 2021
# Source: DEFRA
# URL: https://compliance-data.defra.gov.uk/datasets/Defra::nitrogen-dioxide-hourly-mean-zone-agglomeration-2021/explore
no2_hourly <- read_csv("data/Nitrogen_Dioxide_hourly_mean_Zone_Agglomeration_2021.csv")

# PM10 annual mean Zone Agglomeration 2021
# Source: DEFRA
# URL: https://compliance-data.defra.gov.uk/datasets/Defra::pm10-annual-mean-zone-agglomeration-2021/explore
pm10_annual <- read_csv("data/PM10_annual_mean_Zone_Agglomeration_2021.csv")

# PM10 daily mean Zone Agglomeration 2021
# Source: DEFRA
# URL: https://compliance-data.defra.gov.uk/datasets/Defra::pm10-daily-mean-zone-agglomeration-2021/explore
pm10_daily <- read_csv("data/PM10_daily_mean_Zone_Agglomeration_2021.csv")

# PM2.5 annual mean Zone Agglomeration 2021
# Source: DEFRA
# URL: https://compliance-data.defra.gov.uk/datasets/Defra::pm2-5-annual-mean-zone-agglomeration-2021/explore
pm25_annual <- read_csv("data/PM2_5_annual_mean_Zone_Agglomeration_2021.csv")
...
The UK is divided into 43 zones for air quality assessment. These tables show how they fared under the [UK's annual air quality compliance assessment](https://uk-air.defra.gov.uk/air-pollution/uk-eu-limits) in 2021.
